...
CREATE TABLE IF NOT EXISTS docentes (
    ...
    horas_pat_proyecto INT NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS distribucion_horaria (
    ...
    UNIQUE KEY uniq_distribucion (grupo_id, asignatura_id),
    CONSTRAINT fk_distribucion_grupo FOREIGN KEY (grupo_id) REFERENCES grupos(id) ON DELETE CASCADE,
    CONSTRAINT fk_distribucion_asignatura FOREIGN KEY (asignatura_id) REFERENCES asignaturas(id) ON DELETE CASCADE
);
